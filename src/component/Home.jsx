...
const Home = () => {
  ...
  // const changeDiv =document.getElementById('slide')

  const handleSlide=()=>{
    setMenuButton(true)
    // changeDiv.setAttribute("class","slideDiv")
  }
  return (
    <>
      ...
      <div className='recomendedmovies container'>
        ...
        <NavLink className='rightnavlink' to='/movie'>See all</NavLink>
      </div>
      ...
      <div className='container'>
        <div className='row'>
          {data.map((product, index) => {
            if (index < 4) {
              return (
                <div key={product.id} onClick={() => handleSelect(product.id)} className='col-lg-3  col-md-6 col-sm-12 mb-3'>
                  <div className='card'>
